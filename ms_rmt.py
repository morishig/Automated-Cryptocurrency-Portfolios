...
weighted_returns.to_excel(r'/Users/gmmtakane/Desktop/Thesis/weighted_returns ms_rmt monthly' + '.xlsx', index = True)
weight_matrix.to_excel(r'/Users/gmmtakane/Desktop/Thesis/weights ms_rmt monthly' + '.xlsx')
returns.to_excel(r'/Users/gmmtakane/Desktop/Thesis/log returns ms_rmt monthly' + '.xlsx')
