...
weighted_returns.to_excel(r'/Users/gmmtakane/Desktop/Thesis/weighted_returns msXXX' + '.xlsx', index = True)
weight_matrix.to_excel(r'/Users/gmmtakane/Desktop/Thesis/weights msXXX' + '.xlsx')
returns.to_excel(r'/Users/gmmtakane/Desktop/Thesis/log returns msXXX' + '.xlsx')
