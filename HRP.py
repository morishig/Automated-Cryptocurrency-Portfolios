...
weighted_returns.to_excel(r'/Users/gmmtakane/Desktop/Thesis/weighted_returns hrp monthly' + '.xlsx', index = True)
weight_matrix.to_excel(r'/Users/gmmtakane/Desktop/Thesis/weights hrp monthly' + '.xlsx')
returns.to_excel(r'/Users/gmmtakane/Desktop/Thesis/log returns hrp monthly' + '.xlsx')
